...
- **[`demo-script.md`](demo-script.md)** — the run-of-show: every command and what to point out on screen.
- **[`demo-assets/`](demo-assets/)** — the buggy `calculator.js` Claude works on, plus a large generated Beads export for the migration and speed test.
